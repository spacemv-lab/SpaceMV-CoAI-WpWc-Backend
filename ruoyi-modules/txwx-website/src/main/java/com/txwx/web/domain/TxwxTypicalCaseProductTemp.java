...
/**
 * 典型案例/典型产品临时表 typical_case_product_temp
 * 
 * @author txwx
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class TxwxTypicalCaseProductTemp extends BaseEntity
{
    ...
    public void setStandardFunctionsStr(String standardFunctionsStr) {
        this.standardFunctionsStr = standardFunctionsStr;
    }

    public void setCustomServicesStr(String customServicesStr) {
        this.customServicesStr = customServicesStr;
    }
