...
import com.txwx.social.dashboard.domain.ArticleReadDaily;
import com.txwx.social.dashboard.domain.ArticleShareDaily;
...
public class WebChatHistoryDataCapture {
     ...
     */
    public void captureArticleReadDailyHistory(String accessToken, Long accountId) {
     ...
     */
    public void captureArticleSummaryDailyHistory(String accessToken, Long accountId) {
     ...
     */
    public void captureArticleShareDailyHistory(String accessToken, Long accountId) {
