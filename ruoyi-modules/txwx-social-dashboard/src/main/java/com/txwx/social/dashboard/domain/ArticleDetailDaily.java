...
public class ArticleDetailDaily {
    ...
    public static class DetailList {
         ...
         */
        public Object[] toClickHouseRow(String refDate, String msgId, Integer pubType, String title, String url, Long accountId) {
    ...
    public List<Object[]> toFlattenObjectList(Long accountId) {
