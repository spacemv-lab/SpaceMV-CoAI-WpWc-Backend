...
public class SexController extends BaseController {
    ...
    public AjaxResult importExcel(@RequestPart("file") MultipartFile file, HttpServletResponse response) throws Exception {
        // 需要先清空表
        String truncateSql = "TRUNCATE TABLE sex_distribution";
        try {
        ...
        String sql = "INSERT INTO sex_distribution (sex, user_number, proportion) VALUES (?, ?, ?)";
        ImportResultVo res = importServiceImpl.importExcel(file, SexDistribution.class,
                sql,
                response, null);
