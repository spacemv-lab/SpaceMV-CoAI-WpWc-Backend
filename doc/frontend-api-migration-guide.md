...
本文档guide用于将前端接口从源服务（http://***REMOVED***:9204）迁移到目标服务（http://localhost:9205）。
...
| 项目 | 源服务 | 目标服务 |
|------|--------|----------|
| 域名 | ***REMOVED***:9204 | localhost:9205 |
| 接口文档 | http://***REMOVED***:9204/swagger-ui/index.html | http://localhost:9205/swagger-ui/index.html |
...
```javascript
// 旧
const API_BASE_URL = 'http://***REMOVED***:9204/api';
